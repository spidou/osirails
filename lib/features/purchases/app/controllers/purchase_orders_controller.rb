class PurchaseOrdersController < ApplicationController
  ...
  def prepare_for_new
    ...
    unless params[:choice] or params[:supplier_id]
      @suppliers = PurchaseRequestSupply.get_all_suppliers_for_all_pending_purchase_request_supplies.paginate(:page => params[:page], :per_page => PurchaseOrder::REQUESTS_PER_PAGE)
    end
  end
