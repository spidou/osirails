module QuotationRequestSuppliesHelper
  def display_add_free_quotation_request_supply_for(quotation_request)
    button_to_function "Ajouter une fourniture qui n'existe pas dans la base"  do |page|
      page.insert_html :bottom, :quotation_request_supplies_body, :partial => 'quotation_request_supplies/quotation_request_supply', :object  => quotation_request.quotation_request_supplies.build, :locals => {:quotation_request => quotation_request}
  ...
  def display_add_comment_line_for(quotation_request)
    button_to_function "Ajouter ligne de commentaire"  do |page|
      page.insert_html :bottom, :quotation_request_supplies_body, :partial => 'quotation_request_supplies/quotation_request_supply', :object  => quotation_request.quotation_request_supplies.build(:comment_line => true), :locals => {:quotation_request => quotation_request}
