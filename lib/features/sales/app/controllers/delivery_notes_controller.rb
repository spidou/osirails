class DeliveryNotesController < ApplicationController
  ...
  def realize_form
    error_access_page(412) unless @delivery_note.can_be_realized? and @delivery_intervention = @delivery_note.pending_delivery_intervention
  ...
  def realize
    ...
    if @delivery_note.can_be_realized? and @delivery_intervention = @delivery_note.pending_delivery_intervention
      @delivery_intervention.attributes = params[:delivery_intervention]
