  ...
  def show
    respond_to do |format|
      ...
      format.pdf {
        ...
        render_pdf(pdf_filename, "delivery_notes/show.xml.erb", "delivery_notes/show.xsl.erb", "assets/pdf/delivery_notes/#{pdf_filename}.pdf", @delivery_note.reference.nil?)
      }
      format.html { }
    end
  end
