module DeliveryInterventionsHelper
  ...
  def display_delivery_intervention_show_button(delivery_intervention, options = {})
    ...
    link_to options[:image_tag] + options[:link_text], order_delivering_step_delivery_step_delivery_note_delivery_intervention_path(order, delivery_note, delivery_intervention, options[:options] || {})
  end
  ...
  def display_delivery_intervention_download_report_button(delivery_intervention, options = {})
    ...
    link_to options[:image_tag] + options[:link_text], order_delivering_step_delivery_step_delivery_note_delivery_intervention_report_path(order, delivery_note, delivery_intervention, options[:options] || {})
  end
