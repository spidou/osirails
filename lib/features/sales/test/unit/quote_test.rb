...
class QuoteTest < ActiveSupport::TestCase
  ...
  should_belong_to :order, :send_quote_method, :order_form_type
  ...
  #TODO the following tests need to be reviewed and adapted to new validate rules in Quote, and to take into account the service_deliveries
  #     find a way to test quote with a better and simpler principle than use_cases like below
...
#      assert_equal @quote.net_to_paid, @quote.net + @quote.carriage_costs + @quote.summon_of_taxes
#    end
#    
...
#            break if index == y
#            @quote.quote_items.build( :quotable_type  => end_product.class.name,
