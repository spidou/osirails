...
class DeliveryInterventionTest < ActiveSupport::TestCase
  #TODO review all tests for delivery_intervention
...
#    build_default_delivery_intervention
#    
#    intervention = DeliveryIntervention.new
#    intervention.valid?
...
#    @intervention.valid?
#    assert @intervention.errors.invalid?(:deliverers), "deliverers should NOT be valid because it's not empty while on_site = false"
#  end
#  
...
#    @intervention.valid?
#    assert @intervention.errors.invalid?(:deliverers), "deliverers should NOT be valid because it's empty while on_site = true"
#    
#    @intervention.deliverers << Employee.first
#    assert_equal 1, @intervention.deliverers.size, "deliverers.size should be equal to 1"
#    @intervention.valid?
...
#    @intervention = create_valid_delivery_intervention_for(@delivery_note)
#    assert @intervention.instance_of?(DeliveryIntervention), "@intervention should be an instance of DeliveryIntervention"
#    assert !@intervention.new_record?, "@intervention should NOT be a new record"
#  end
#  
#  def test_update_delivery_intervention
#    @intervention = create_valid_delivery_intervention_for(@delivery_note)
#    @intervention.delivered = true
...
#  
#  private
#    def build_default_delivery_intervention
#      @intervention = @delivery_note.delivery_interventions.build
#      @intervention.valid?
#    end
