class Iban < ActiveRecord::Base
  ...
  validates_format_of 'branch_code',:with => /^[0-9]{0,5}$/, :message => "Le code  guichet doit contenir 5 chiffres"
  validates_format_of 'account_number',:with => /^[0-9]{0,11}$/, :message => "le numéros de compte doit contenir 11 chiffres"
