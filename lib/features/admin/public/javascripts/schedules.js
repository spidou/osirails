...
{ 
  ...
  for(i = 0; i < period.length ; i ++)
  {
    ...
    if(period[i]!=0)
    {
      ...
      retour += "<th class=\"day\" name=" + day + ">" + day + "</th>";
      retour += "<td class=\"morning start\" name=" + day + ">" + document.getElementById(1).value +" H "+  document.getElementById(2).value + "</td>";
      retour += "<td class=\"morning end\" name=" + day + ">" + document.getElementById(3).value +" H "+  document.getElementById(4).value + "</td>";
      retour += "<td class=\"afternoon start\" name=" + day + ">" + document.getElementById(5).value +" H "+  document.getElementById(6).value + "</td>";
      retour += "<td class=\"afternoon end\" name=" + day + ">" + document.getElementById(7).value +" H "+  document.getElementById(8).value + "</td>";
