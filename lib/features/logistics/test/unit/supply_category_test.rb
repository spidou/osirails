module SupplyCategoryTest  
  ...
  def test_persistent_attributes_when_disable
    flunk "@supply_category_with_parent must be disabled" unless @supply_category_with_parent.disable
  ...
  def test_enabled_roots
    ...
    flunk "@supply_category_with_parent must be disabled" unless @supply_category_with_parent.disable
    flunk "@supply_category must be disabled" unless @supply_category.disable
  ...
  def test_disable_root_child_when_supplies_in
    ...
    for supply in @supply_category_root_child.supplies
      ...
      flunk "supply should be disabled" unless supply.disable
    end
  ...
  def test_destroy_root_child
    ...
    flunk "@supply_category_with_parent must be destroyed" unless @supply_category_with_parent.destroy
  end
  ...
  def test_destroy_root_child_when_supplies_in
    ...
    for supply in @supply_category_root_child.supplies
      flunk "supply should be destroyed" unless supply.destroy
    end
  ...
  def test_has_children_disable
    ...
    for supply in @supply_category_root_child.supplies
      ...
      sleep(1)
      flunk "stock flow must be saved" unless new_stock_flow(supply,supply.suppliers.first,false,5)
      flunk "supply should be destroyed" unless supply.disable
    end
    @supply_category_root_child.reload
