class VehiclesController < ApplicationController
  ...
  def show
    ...
    @effectives_events = @vehicle.tool_events.desc.effectives.all(:limit => 3, :order => "start_date DESC") 
    @scheduled_events  = @vehicle.tool_events.desc.scheduled.all(:limit => 3, :order => "start_date DESC")
  end
