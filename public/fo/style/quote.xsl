    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:rx="http://www.renderx.com/XSL/Extensions" 
      ...
      <fo:page-sequence format="1" master-reference="unnamed" initial-page-number="1">
              ...
              <fo:table-row background-color="rgb(0,0,0)" page-break-inside="avoid">
                ...
                <fo:table-cell width="5cm" display-align="center" text-align="center">
                  <fo:block font-size="10px" color="rgb(255,255,255)">
                    <xsl:value-of select="Supplier/Address1"/>&#160;<xsl:value-of select="Supplier/Address2"/><fo:inline><fo:block/></fo:inline>
              ...
              <fo:table-row page-break-inside="avoid">
                ...
                <fo:table-cell display-align="after">
                  <fo:block text-align="end"
                    ...
                    <fo:retrieve-marker retrieve-class-name="report-label" 
                                        retrieve-boundary="page" 
                                        retrieve-position="last-starting-within-page"/>&#160;<fo:retrieve-marker retrieve-class-name="report-value" 
                                                                                                                 retrieve-boundary="page" 
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block background-image='../images/background.png' 
                    background-repeat="no-repeat"
                    background-position-horizontal="1.5cm" 
                    background-position-vertical="2.2cm">
              
            <fo:block font-weight="bold" font-size="24.0px">
              <xsl:value-of select="Type"/>&#160;
              <xsl:value-of select="../Labels/Prefix"/>&#160;
                ...
                <fo:table-row page-break-inside="avoid">
                  <fo:table-cell number-columns-spanned="5">
                    <fo:block font-size="10.0px">
                      ...
                      <fo:block font-weight="bold">
                        <xsl:value-of select="../Labels/SupplierPrefix"/>&#160;
                        <xsl:value-of select="Supplier/CorporateName2"/>:
                      </fo:block>
                  ...
                  <fo:table-cell padding-left="1cm" number-columns-spanned="5">
                    <fo:block>
                      ...
                      <xsl:value-of select="../Labels/CustomerPrefix"/>&#160;
                      <xsl:value-of select="Customer/Representative/FirstName"/>&#160;<xsl:value-of select="Customer/Representative/LastName"/><fo:inline><fo:block/></fo:inline>
            ...
            <fo:table display-align="after" margin-bottom="2pt" border="black" border-style="solid" border-width="1px">
              <fo:table-body>                          
                ...
                <fo:table-row keep-with-next="always" page-break-inside="avoid" unicode-bidi="embed">
                  <fo:table-cell padding="1pt" font-size="8.0px" display-align="before" number-columns-spanned="10">
                    <fo:block text-align="center">
                ...
                <fo:table-row page-break-inside="avoid">
                  ...
                  <fo:table-cell number-columns-spanned="5">
                    <fo:block font-size="10.0px" font-weight="bold" font-style="italic" text-align="right">
                      <xsl:value-of select="../Labels/Amount"/>&#160;
