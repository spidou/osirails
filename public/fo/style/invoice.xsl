                  ...
                  <fo:table-cell number-columns-spanned="5">
                    <fo:block-container font-size="10.0px" overflow="hidden" wrap-option="no-wrap">
                      ...
                      <fo:block>
                        ...
                        <fo:inline>
                          <xsl:value-of select="Supplier/AdministrativelRepresentative/FirstName"/>&#160;<xsl:value-of select="Supplier/AdministrativeRepresentative/LastName"/>
                        </fo:inline>
                      </fo:block>
                      <fo:block>
                        <fo:inline>
                        ...
                        <fo:inline>
                          <xsl:value-of select="Supplier/AdministrativelRepresentative/Email"/>
                        </fo:inline>
                      </fo:block>
                    </fo:block-container> 
                  </fo:table-cell>
...
<!-- FOOTER IS REQUIRED TO CLOSE THE TABLE ON PAGE BREAKS                  -->
                ...
                <fo:table-row keep-with-next="always">
                  <fo:table-cell padding-bottom="2mm" padding-right="2pt" number-columns-spanned="3">                    
                    <fo:table display-align="after" font-size="9.0px" border-color="black" border-width="1px" border-style="solid">
                      <fo:table-body>
                        <fo:table-row keep-with-next="always" page-break-inside="avoid">
                          <fo:table-cell padding="1pt" font-size="10.0px" background-color="rgb(255, 149 , 14)" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="1.0px" border-left-color="black" display-align="before" number-columns-spanned="4">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              <fo:block text-align="center" font-weight="bold">
                        ...
                        <fo:table-row keep-with-next="always" page-break-inside="avoid">
                          <fo:table-cell padding="1pt" display-align="before" number-columns-spanned="2">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              <fo:block font-weight="bold" font-size="8.0px" text-align="start">
                          ...
                          <fo:table-cell padding="1pt" display-align="before" number-columns-spanned="2">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              <fo:block font-size="8.0px" text-align="start">
                        ...
                        <fo:table-row keep-with-next="always" page-break-inside="avoid">
                          <fo:table-cell padding="1pt" display-align="before" number-columns-spanned="2">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              ...
                              <fo:block font-style="italic" font-size="7.0px" text-align="start">
                        ...
                        <fo:table-row keep-with-next="always" page-break-inside="avoid">
                          <fo:table-cell padding="1pt" display-align="before" number-columns-spanned="2">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              <fo:block font-weight="bold" font-size="8.0px" text-align="start">
                                <xsl:value-of select="../Labels/BalanceTotal"/>
                              </fo:block>
                            </fo:block-container>
                          </fo:table-cell>
                          <fo:table-cell padding="1pt" display-align="before" number-columns-spanned="2">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              <fo:block font-size="8.0px" text-align="start">
                                <xsl:value-of select="InvoicingState/BalanceTotal"/>
                              </fo:block>
                            </fo:block-container>
                          </fo:table-cell>
                        </fo:table-row>
                ...
                <fo:table-row keep-with-next="always">
                  <fo:table-cell padding-bottom="5mm" padding-right="2pt" number-columns-spanned="3">                    
                    <fo:table display-align="after" font-size="9.0px" border-color="black" border-width="1px" border-style="solid">
                      ...
                      <fo:table-body>
                        <fo:table-row keep-with-next="always" page-break-inside="avoid">
                          <fo:table-cell padding="1pt" font-size="10.0px" background-color="rgb(255, 149 , 14)" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="1.0px" border-left-color="black" display-align="before" number-columns-spanned="2">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              <fo:block text-align="center" font-weight="bold">
                        ...
                        <fo:table-row background-color="rgb(230, 230, 230)" keep-with-next="always" page-break-inside="avoid">
                          <fo:table-cell padding="1pt" display-align="before" border-color="black" border-style="solid" border-width="1.0px">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              <fo:block font-weight="bold" font-size="8.0px" text-align="center">
                  ...
                  <fo:table-cell padding-bottom="5mm" padding-right="2pt">
                    <fo:block/>
                  </fo:table-cell>
                  <fo:table-cell padding-left="1cm" padding-bottom="5mm" padding-right="2pt" number-columns-spanned="5">   
                    <fo:table display-align="after" font-size="9.0px" border-top-color="black" border-top-width="1px" border-top-style="solid">
                      <fo:table-column column-width="2cm"/>
                      <fo:table-column column-width="4cm"/>
                      <fo:table-column column-width="4cm"/>
                      <fo:table-body>
                        <fo:table-row keep-with-next="always" page-break-inside="avoid">
                          <fo:table-cell padding="1pt" font-size="10.0px" background-color="rgb(255, 149 , 14)" border-left-color="black" border-left-width="1px" border-left-style="solid" border-right-color="black" border-right-width="1px" border-right-style="solid" border-bottom-color="black" border-bottom-style="solid" border-bottom-width="1.0px" display-align="before" number-columns-spanned="3">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              <fo:block text-align="center" font-weight="bold">
                        ...
                        <fo:table-row background-color="rgb(230, 230, 230)" keep-with-next="always" page-break-inside="avoid" border-left-color="black" border-left-width="1px" border-left-style="solid" border-right-color="black" border-right-width="1px" border-right-style="solid">
                          <fo:table-cell padding="1pt" display-align="before" border-color="black" border-style="solid" border-width="1.0px">
                            <fo:block-container overflow="hidden" wrap-option="no-wrap">
                              <fo:block font-weight="bold" font-size="8.0px" text-align="center">
                                <xsl:value-of select="../Labels/DueDatesDate"/>
                  ...
                  <fo:table-cell padding-top="13.9mm">
                    <fo:table>
                      <fo:table-body>
  ...
  <xsl:template match="DueDates/DueDate" mode="DueDates">
    <fo:table-row keep-with-next="always" page-break-inside="avoid" border-color="black" border-style="solid" border-width="1pt">
      <fo:table-cell padding="1pt" display-align="center" border-color="black" border-style="solid" border-width="1.0px">
        <fo:block-container height="5mm" overflow="hidden" wrap-option="no-wrap">
          <fo:block font-size="8.0px" text-align="center">
            <xsl:value-of select="Date"/>
          </fo:block>
        </fo:block-container>
      </fo:table-cell>
  ...
  <xsl:template match="DueDates/DueDate" mode="FormToCut">
    <fo:table-row keep-with-next="always" page-break-inside="avoid" border-color="black" border-style="dashed" border-width="1pt">
      <fo:table-cell padding="1pt" display-align="center" border-right-color="black" border-right-style="solid" border-right-width="1.0px">
        <fo:block-container height="5mm" overflow="hidden" wrap-option="no-wrap">
          <fo:block font-size="8.0px" text-align="center">
            <xsl:value-of select="Date"/>
          </fo:block>
  ...
  <xsl:template match="DueDates/DueDate" mode="Scissors">
    <fo:table-row>
      <fo:table-cell padding-bottom="1.55mm" text-align="end">
        <fo:block>
          <fo:external-graphic content-height="3mm" src="../images/scissors.png"/>
        </fo:block>
      </fo:table-cell>
    </fo:table-row>
  </xsl:template>
