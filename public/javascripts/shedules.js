...
{ 
  ...
  for(i = 0; i < period.length ; i ++)
  {
    ...
    if(period[i]!=0)
    {
      ...
      document.getElementById("schedules[" + period[i] + "]").value =  document.getElementById(1).value +" H "+  document.getElementById(2).value + "|" + document.getElementById(3).value +" H "+  document.getElementById(4).value + "|" + document.getElementById(5).value + " H " +  document.getElementById(6).value + "|" + document.getElementById(7).value + " H " +  document.getElementById(8).value
      retour = "";
    }
  } 
}
