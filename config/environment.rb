...
Rails::Initializer.run do |config|
  ...
  config.plugins = [:acts_as_tree, :acts_as_list, :acts_as_taggable_on_steroids, :acts_as_versioned, :validates_persistence_of, :paperclip, :has_permissions, :has_search_index, :has_documents, :has_numbers,:all]
